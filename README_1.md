...
1. [Network & Hypervisor Setup](#phase-1-network--hypervisor-setup)
2. [Installing Windows Server](#phase-2-installing-windows-server)
3. [Post-Install Configuration](#phase-3-post-install-configuration)
4. [Static IP & Hostname](#phase-4-static-ip--hostname)
5. [Installing Active Directory Domain Services](#phase-5-installing-active-directory-domain-services)
6. [Promoting the Domain Controller](#phase-6-promoting-the-domain-controller)
7. [Organizational Unit Structure](#phase-7-organizational-unit-structure)
8. [Bulk User Provisioning with PowerShell](#phase-8-bulk-user-provisioning-with-powershell)
9. [Group Policy Enforcement](#phase-9-group-policy-enforcement)
10. [Client Workstation Setup](#phase-10-client-workstation-setup)
11. [Domain Join](#phase-11-domain-join)
12. [Verifying the Setup](#phase-12-verifying-the-setup)
...
graph LR
    ...
    subgraph VMnet1["VMnet1 - Host-only, isolated"]
        DC["Corp-DC01<br/>Windows Server 2016<br/>192.168.100.10<br/>AD DS / DNS / DHCP"]
        Client["Corp-Client01<br/>Windows 10 Pro<br/>192.168.100.20"]
    end
    Host -.blocked.-> Internet
    DC --- Client
```
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/49d09961-0830-43ed-8507-a068b0026367)
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/9c1db3f1-b2eb-4692-98fa-be047a556bd0)
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/9d4f84c9-f6e7-4a47-803a-83e58784607c)
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/0ca1d9b7-c0fd-4a0e-81b3-f6125d118e96)
...
```powershell
# Password redacted — replace with your own before running
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/8be31348-a965-412e-9fd0-66fb6f2c07ad)
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/8175a910-da95-4583-b769-28095a0477c7)
...
### Verification
![Phase verification screenshot](https://github.com/user-attachments/assets/d0d03892-3b26-4677-bed1-943b7f770209)
